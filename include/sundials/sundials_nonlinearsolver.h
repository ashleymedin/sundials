...
struct _generic_SUNNonlinearSolver_Ops
{
  ...
  SUNErrCode (*getresnrm)(SUNNonlinearSolver, sunrealtype* resnrm);
};
...
#define SUN_NLS_CONV_SLOW  +903 /* convergece is slow    */
#define SUN_NLS_DIVERGING  +904 /* solution is diverging */
